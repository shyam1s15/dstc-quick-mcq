                ...
                <div class="card" id="app_createForm2">
                    <div class="">
                        ...
                        <section id="contact">
                            ...
                            <h2 class="mb-1 mt-1 font-weight-bold text-center green-text">Make Your Questions</h2>
                                    ...
                                    <div class="symmentric-padding-2 mr-2 ml-2">
                                        <form class="p-1 grey-text">
                                            <div class="md-form form-sm"> <i class="fas fa-user prefix green-text"></i>
                                                <input type="text" id="form3" class="form-control form-control-sm"
                                                    required>
                                                <label for="form3" class="required">A question is What is Question
                                                    ??</label>
                                            </div>
                                        </form>
                                    </div>
                                ...
                                <div class="col-md-4 col-lg-5">
                                    <div class="symmentric-padding-2 mr-2 ml-2">
                                        <form class="p-1 grey-text form-check">
                                            <div class="md-form form-sm"> <i class="fas fa-thumbs-up prefix red-text"
                                                    id="option1"></i>
                                                <input type="text" id="form3" class="form-control form-control-sm"
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <button type="submit" class="btn btn-primary float-left ml-5" id="saveQuesBtn">
