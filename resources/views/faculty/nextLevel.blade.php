      ...
      <form class="p-1 grey-text">
        <div class="md-form form-sm">
          ...
          <div class="md-form form-sm">
            ...
            <label for="passing" class="required" id="passingLabel">Marks out of X</label>
          </div>
        </div>
      </form>
    </div>
      ...
      <form class="p-1 grey-text">
        <div class="md-form form-sm">
          ...
          <div class="md-form form-sm"><i class="fas fa-envelope prefix cust-dstc-nav-color"></i>
            ...
            <label for="passingMsg" class="required">Message for Passing Students</label>
          </div>
        </div>
      </form>
    </div>
      ...
      <form class="p-1 grey-text">
        <div class="md-form form-sm">
          ...
          <div class="md-form form-sm">
            ...
            <label for="EliteMarks" class="required" id="EliteMarksLabel">Marks out of X</label>
          </div>
        </div>
      </form>
    </div>
      ...
      <form class="p-1 grey-text">
        <div class="md-form form-sm">
          ...
          <div class="md-form form-sm"><i class="fas fa-envelope prefix cust-dstc-nav-color"></i>
            ...
            <label for="EliteMsg" class="required">Message for Elite Students</label>
          </div>
        </div>
      </form>
    </div>
