      ...
      <form class="p-1 grey-text">
        <div class="md-form form-sm">
          ...
          <div class="md-form form-sm">
            ...
            <label for="passing" class="required" id="passingLabel">{{ $marks[ $index ] }} out of {{ $level->passing }}</label>
          </div>
        </div>
      </form>
    </div>
      ...
      <form class="p-1 grey-text">
        <div class="md-form form-sm">
          ...
          <div class="md-form form-sm"><i class="fas fa-envelope prefix green-text"></i>
            <input type="text" name="passing-marks" id="passingMsg" class="form-control form-control-sm" disabled>
      ...
      <form class="p-1 grey-text">
        <div class="md-form form-sm">
          ...
          <div class="md-form form-sm">
            ...
            <label for="EliteMarks" class="required" id="EliteMarksLabel">{{ $marks[ $index ] }} out of {{ $level->Elite }}</label>
          </div>
        </div>
      </form>
    </div>
    ...
    <div class="symmentric-padding-2 mr-2 ml-2">
      <form class="p-1 grey-text">
        <div class="md-form form-sm">
          ...
          {{--  <input type="file" style="display: none" id="questionImageFile">  --}}
          <div class="md-form form-sm"><i class="fas fa-envelope prefix green-text"></i>
            <input type="text" name="Elite-marks" id="EliteMsg" class="form-control form-control-sm" disabled>
...
<a href="{{ env('APP_URL') }}/student/showChoices" class="btn btn-danger"> Finish </a>
@endforeach
